...
class FanvueMassDMBot:
    ...
    def click_new_mass_dm_button(self):
        ...
        try:
            ...
            self.page.wait_for_selector(new_mass_dm_selector, timeout=10000)
            self.page.click(new_mass_dm_selector)
            time.sleep(3)
    ...
    def click_select_lists_button(self):
        ...
        try:
            ...
            self.page.wait_for_selector(select_lists_selector, timeout=10000)
            self.page.click(select_lists_selector)
            time.sleep(3)
    ...
    def select_audience(self, audience_type="all_contacts"):
        ...
        try:
            ...
            if is_disabled:
                ...
                for fallback in fallback_options:
                    ...
                    try:
                        is_fallback_disabled = self.page.locator(fallback_selector).is_disabled()
