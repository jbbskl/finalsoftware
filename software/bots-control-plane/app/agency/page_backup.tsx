  ...
  return (
    <div className="space-y-6">
      ...
      {kpisLoading ? (
        ...
        <div className="text-center text-muted-foreground">No KPI data available</div>
      )}
      ...
      {runsLoading ? (
        ...
        <div className="text-center text-muted-foreground">No recent activity available</div>
      )}
    </div>
  )
}
