...
import { Loader2, Save, User, Building, Bell, Crown } from "lucide-react";
...
export default function SettingsAgencyView() {
        ...
        <div className="grid gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Company details used for invoicing and billing
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
      ...
      <div className="grid gap-6">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p>Unlimited (6 Creator + Agency Bots)</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your agency subscription includes these premium features
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">Multi-platform automation</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-2 w-2 bg-green-500 rounded-full" />
