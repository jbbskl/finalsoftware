...
export default function DashboardAgency() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        console.log("[v0] Fetching agency dashboard data...")
        ...
        console.log("[v0] Error fetching agency dashboard data:", error)
      } finally {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Agency Dashboard" description="Overview of your agency's bot automation system" />
